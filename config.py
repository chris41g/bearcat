...
class Config:
    ...
    # Database settings
    DATABASE_PATH = os.environ.get('DATABASE_PATH') or '/opt/activediscovery/network_discovery.db'
    ...
    SCANNER_SCRIPT_PATH = os.environ.get('SCANNER_SCRIPT_PATH') or '/opt/activediscovery/b-activedisc.py'
    ...
    # Logging
    LOG_PATH = os.environ.get('LOG_PATH') or '/opt/activediscovery/logs'
